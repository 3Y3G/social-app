...
const posts = [
  {
    ...
    content: "Току-що завърших страхотна книга! Какво четете тези дни?",
    image: null,
    likes: 15,
    comments: [
      { id: 1, author: "Jane Smith", content: "Чета Среднощната библиотека. Фантастично е!" },
      { id: 2, author: "Mike Johnson", content: "Току-що започнах Atomic Habits. Силно го препоръчвам!" },
    ],
    shares: 1,
  },
  {
